...
function bizznis_inpost_layout_box() {
	...
	<?php endif; ?>
		...
		<tr valign="top">
			<th scope="row"><label for="bizznis_custom_post_class"><?php _e( 'Custom Post Class', 'bizznis' ); ?></label></th>
			<td><p><input class="large-text" type="text" name="bizznis_layout[_bizznis_custom_post_class]" id="bizznis_custom_post_class" value="<?php echo esc_attr( bizznis_get_custom_field( '_bizznis_custom_post_class' ) ); ?>" /></p></td>
		</tr>
		<tr valign="top">
			<th scope="row"><?php _e( 'Header Settings', 'bizznis' ); ?></th>
			<td>
				<p>
...
function bizznis_inpost_scripts_box() {
	...
	<tbody>
		<tr valign="top">
			<th scope="row"><label for="bizznis_scripts"><strong><?php _e( 'Page-specific Scripts', 'bizznis' ); ?></strong></label></th>
			<td>
				<p><textarea class="widefat" rows="4" name="bizznis_scripts[_bizznis_scripts]" id="bizznis_scripts"><?php echo esc_textarea( bizznis_get_custom_field( '_bizznis_scripts' ) ); ?></textarea></p>
