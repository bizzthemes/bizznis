...
class Bizznis_CSS {
	...
	/**
	 * The one instance of Bizznis_CSS.
	 *
	 * @since 1.1.0.
	 *
	 * @var   Bizznis_CSS    The one instance for the singleton.
	 */
	...
	/**
	 * Instantiate or return the one Bizznis_CSS instance.
	 *
	 * @since  1.1.0.
	 *
	 * @return Bizznis_CSS
	...
	private function parse_declarations( $declarations, $tab = '' ) {
		 ...
		 * routines are implemented when the developer calls `bizznis_get_css->add()`. Because every property value has
...
/**
 * Return the one Bizznis_CSS object.
 *
 * @since  1.1.0.
 *
 * @return Bizznis_CSS    The one Bizznis_CSS object.
 */
add_action( 'init', 'bizznis_get_css', 1 );
function bizznis_get_css() {
