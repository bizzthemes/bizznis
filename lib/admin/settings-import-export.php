				...
				<tbody>
					<tr>
						...
						<td>
							...
							<p>
								<form enctype="multipart/form-data" method="post" action="<?php echo menu_page_url( 'bizznis-import-export', 0 ); ?>">
					...
					<tr>
						...
						<td>
							...
							<p>
								<form method="post" action="<?php echo menu_page_url( 'bizznis-import-export', 0 ); ?>">
									<?php
