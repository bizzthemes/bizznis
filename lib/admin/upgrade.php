...
function bizznis_upgrade() {
	...
	*/
	# UPDATE DB TO VERSION 1320
	if ( bizznis_get_option( 'db_version', null, false ) < '1320' ) {
		bizznis_upgrade_1320();
	}
	do_action( 'bizznis_upgrade' );
}

/**
 * Upgrade the database to version 1320.
 *
 * @since 1.0.0
 */
function bizznis_upgrade_1320() {
	# Update Settings
