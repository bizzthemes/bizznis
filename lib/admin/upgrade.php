...
function bizznis_upgrade() {
	...
	*/
	# UPDATE DB TO VERSION 1200
	if ( bizznis_get_option( 'db_version', null, false ) < '1200' ) {
		bizznis_upgrade_1200();
	}
	do_action( 'bizznis_upgrade' );
}

/**
 * Upgrade the database to version 1200.
 *
 * @since 1.0.0
 */
function bizznis_upgrade_1200() {
	# Update Settings
