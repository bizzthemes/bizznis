 ...
 * @since 1.0.0
 */
class Bizznis_Admin_SEO_Settings extends Bizznis_Admin_Boxes {
	 ...
	 */
	function metaboxes() {
		add_meta_box( 'bizznis-seo-settings-doctitle', __( 'Document Title', 'bizznis' ), array( $this, 'doctitle_box' ), $this->pagehook, 'main' );
		add_meta_box( 'bizznis-seo-settings-dochead', __( 'Document Head', 'bizznis' ), array( $this, 'document_head_box' ), $this->pagehook, 'main' );
		add_meta_box( 'bizznis-seo-settings-homepage', __( 'Homepage', 'bizznis' ), array( $this, 'homepage_box' ), $this->pagehook, 'column2' );
		add_meta_box( 'bizznis-seo-settings-robots', __( 'Robots Meta', 'bizznis' ), array( $this, 'robots_meta_box' ), $this->pagehook, 'column3' );
		add_meta_box( 'bizznis-seo-settings-archives', __( 'Archives', 'bizznis' ), array( $this, 'archives_box' ), $this->pagehook, 'column3' );
	}
	...
	function doctitle_box() {
		?>
		<p><span class="description"><?php printf( __( 'The document title (%s) is the single most important element in your document source for <abbr title="Search engine optimization">SEO</abbr>. It succinctly informs search engines of what information is contained in the document. The title can, and should, be different on each page, but these options will help you control what it will look like by default.', 'bizznis' ), bizznis_code( '<title>' ) ); ?></span></p>
		<p><span class="description"><?php _e( '<strong>By default</strong>, the home page document title will contain the site title, the single post and page document titles will contain the post or page title, the archive pages will contain the archive type, etc.', 'bizznis' ); ?></span></p>
		<p>
		...
		<fieldset>
			<legend><?php _e( 'Document Title Additions Location:', 'bizznis' ); ?></legend>
			<span class="description"><?php _e( 'Determines which side the added title text will go on.', 'bizznis' ); ?></span>
			<p>
		...
		<p>
			...
			<span class="description"><?php _e( 'If the title consists of two parts (original title and optional addition), then the separator will go in between them.', 'bizznis' ); ?></span>
		</p>
		<?php
	}
	...
	function document_head_box() {
		...
		<h4><?php _e( 'Windows Live Writer Support:', 'bizznis' ); ?></h4>
		<p>
		...
		<h4><?php _e( 'Shortlink Tag:', 'bizznis' ); ?></h4>
		<p>
		...
		<p>
			<span class="description"><?php _e( '<span class="bizznis-admin-note">Note:</span> The shortlink tag might have some use for 3rd party service discoverability, but it has no <abbr title="Search engine optimization">SEO</abbr> value whatsoever.', 'bizznis' ); ?></span>
		</p>
		<?php
	}
	...
	function homepage_box() {
		...
		<p><span class="description"><?php printf( __( 'HTML5 allows for multiple %s tags throughout the document source, provided they are the primary title for the section in which they appear. However, following this standard may have a marginal negative impact on SEO.', 'bizznis' ), bizznis_code( 'h1' ) ); ?></span></p>
		<fieldset id="bizznis_seo_h1_wrap">
			<legend><?php printf( __( 'Which text would you like to be wrapped in %s tags?', 'bizznis' ), bizznis_code( 'h1' ) ); ?></legend>
			<p>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'home_doctitle' ); ?>"><?php _e( 'Homepage Document Title:', 'bizznis' ); ?></label><br />
			...
			<span class="description"><?php _e( 'If you leave the document title field blank, your site&#8217;s title will be used instead.', 'bizznis' ); ?></span>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'home_description' ); ?>"><?php _e( 'Home Meta Description:', 'bizznis' ); ?></label><br />
			...
			<span class="description"><?php _e( 'The meta description can be used to determine the text used under the title on search engine results pages.', 'bizznis' ); ?></span>
		</p>
		<h4><?php _e( 'Homepage Robots Meta Tags:', 'bizznis' ); ?></h4>
		<p>
		...
		<h4><?php _e( 'Homepage Author', 'bizznis' ); ?></h4>
		<p>
			<span class="description"><?php printf( __( 'Select the user that you would like to be used as the %s for the homepage. Be sure the user you select has entered their Google+ profile address on the profile edit screen.', 'bizznis' ), bizznis_code( 'rel="author"' ) ); ?></span>
		</p>
		<p>
			<?php
	...
	function robots_meta_box() {
		?>
		<p><span class="description"><?php _e( 'Depending on your situation, you may or may not want the following archive pages to be indexed by search engines. Only you can make that determination.', 'bizznis' ); ?></span></p>
		<p>
		...
		<p><span class="description"><?php printf( __( 'Some search engines will cache pages in your site (e.g. Google Cache). The %1$s tag will prevent them from doing so. Choose which archives you want %1$s applied to.', 'bizznis' ), bizznis_code( 'noarchive' ) ); ?></span></p>
		<p>
	...
	function archives_box() {
		...
		<p>
			<span class="description"><?php _e( 'This option points search engines to the first page of an archive, if viewing a paginated page. If you do not know what this means, leave it on.', 'bizznis' ); ?></span>
		</p>
		<?php
	}
	...
	public function help() {
		...
		$screen->add_help_tab( array(
			...
			'title'	=> __( 'Doctitle Settings' , 'bizznis' ),
